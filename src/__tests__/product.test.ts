...
describe("product", () => {
	...
	describe("create product route", () => {
		...
		describe("given the user is logged in", () => {
			it("should return a 200 and create the product under 200s", async () => {
        ...
        console.log(duration)
				...
				expect(statusCode).toBe(200);
				expect(duration).toBeLessThan(200); // Example threshold for response time
	...
	describe("update product route", () => {
		it("should return a 200 and update the product", async () => {
			...
			const updatedPayload = { ...productPayload, price: 799.99 };
	...
	describe("delete product route", () => {
		it("should return a 204 on successful deletion", async () => {
			const jwt = signJwt(userPayload);
			const product = await createProduct(productPayload);
